...
import { Alert, Box, Button, Grid, List, ListItem, ListItemButton, ListItemIcon, Snackbar, Typography } from '@mui/material'
  ...
  return (
    ...
    <SidebarDiv>
      ...
      <List sx={{ width: '100%' }}>
        ...
        {
          historydata && historydata.map((historyproject, i) => {
            return <Grid key={i} container spacing={0} alignItems="center">
              <Grid item xs={10}>
              ...
              <Grid item xs={2}>
                <IconButton edge="end" aria-label="delete" onClick={() => handleDeleteProject(historyproject.project)}>
                  <DeleteIcon />
                </IconButton>
              </Grid>
            </Grid>

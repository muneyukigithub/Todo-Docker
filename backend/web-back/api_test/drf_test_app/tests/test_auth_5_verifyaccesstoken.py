...
class APIViewsTests(TestCase):
    ...
    def setUp(self):
        ...
        self.VERIFY_URL = "http://localhost:8000/api/v1/jwt_verifyaccesstoken/"
        self.createview = view_auth.jwt_createtoken.as_view()
        self.verifyaccesstokenview = view_auth.jwt_verifyaccesstoken.as_view()
    ...
    def test_auth_3_1_deletetoken(self):
        ...
        response = self.verifyaccesstokenview(set_token(request, token))
